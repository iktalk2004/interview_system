<template>
  <div class="questions-container">
    ...
    <!-- 搜索和过滤 -->
    <el-form :model="filters" label-width="auto" inline>
      <el-form-item label="搜索">
        <el-input v-model="filters.search" placeholder="标题" clearable/>
      </el-form-item>
      ...
      <el-form-item label="审核状态" prop="search">
        <el-select v-model="filters.is_approved" placeholder="审核状态" clearable style="width: 180px;">
